...
Task("build")
	...
	.Does(() => DotNetBuild("PhpMinifier.slnx", new() { Configuration = release ? "Release" : "Debug" }));
...
Task("publish")
	...
	.Does(() => DotNetPack("PhpMinifier.slnx", new() { OutputDirectory = "var" }))
...
Task("test")
	...
	.Does(() => DotNetTest("PhpMinifier.slnx", new() { Settings = ".runsettings" }));
